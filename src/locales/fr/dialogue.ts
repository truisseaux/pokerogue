...
export const PGMdialogue: DialogueTranslationEntries = {
  ...
  "hiker": {
    "encounter": {
      1: "Mon âge m’a donné autant de force que les montagnes que je parcourt !",
      2: "Je tiens ces os solides de mes parents… Je suis comme une chaîne de montagnes vivante…",
    },
    "victory": {
      1: "Au moins, je t’ai battu, pour ce qui est de l’IMC !",
  ...
  "worker": {
    "encounter": {
      1: "Ça me dérange que les gens se trompent toujours sur moi. Je suis beaucoup plus pur qu’on ne le pense.",
    },
    "victory": {
      1: "Je ne veux pas recevoir de coups de soleil, donc je reste à l’ombre quand je bosse.",
    },
  },
  "worker_female": {
    "encounter": {
      1: "Ça me dérange que les gens se trompent toujours sur moi. Je suis beaucoup plus pure qu’on ne le pense.",
    },
    "victory": {
      1: "Je n’aime pas les coups de soleil, donc je reste à l’ombre pendant que je travaille."
    },
    "defeat": {
  ...
  "brock": {
    "encounter": {
      ...
      3: "Je vais te montrer la vraie force de mes Pokémon !"
    },
    "victory": {
  ...
  "misty": {
    ...
    "victory": {
      ...
      3: "Wow, t’es trop fort ! J’arrive pas à croire que tu m’as battue !"
    },
    "defeat": {
  ...
  "erika": {
    "encounter": {
      ...
      3: "Oh, j’espère que l’arôme agréable de mes Pokémon ne vont pas m’endormir…",
  ...
  "crasher_wake": {
    "encounter": {
      1: "Le ring, c’est mon océan ! Sur les flots déchaînés, monde flottant ! C’est moi, LO-VIS ! LO-VIS !!",
      2: "Mes Pokémon encaisseront toutes tes attaques, sans exception, et te feront boire la tasse !",
      3: "Tu as l’honneur de t’adresser au grand Lovis le Teigneux !\nTu vas boire la tasse !"
    },
    "victory": {
      1: "Har, har, har ! C’était un régal ! Merci pour ce combat !",
      2: "Ouah ! La tension est retombée ! Comment dire… ?\nJ’en veux encore ! Je voulais continuer à me battre !",
      3: "QUOOOOI ?!"
    },
    "defeat": {
      1: "Ouaaaais ! ",
  ...
  "roark": {
    "encounter": {
      1: "Jour après jour, je creuse pour trouver des fossiles, et j’entraîne mes Pokémon. Tu vas voir comme ils sont géniaux !",
    ...
    "victory": {
      ...
      4: "Mon entraînement a porté ses fruits !",
      5: "J’ai perdu."
    },
    "defeat": {
      ...
      3: "Je t’ai montré la force des Pokémon Roche !"
    }
  },
  "morty": {
    "encounter": {
    ...
    "victory": {
      ...
      4: `En puissance pure, je ne devais pas être tellement loin derrière.
                $Mais tu as quelque chose de plus… Eh bien, soit.`,
  ...
  "drayton": {
    "encounter": {
      1: `La chaise, c’est la meilleure invention du monde ! 
                $Qui a envie de rester debout ? C’est crevant !`,
    },
    "victory": {
      1: "Ouais, j’aurais dû m’y attendre !"
    },
    "defeat": {
      1: `Hé hé ! Fais pas gaffe à moi, mais ça me fait une victoire de plus. 
                $Je comprends si t’es contrarié, mais fais pas comme Kassis, OK ?`
    }
  },
  "ramos": {
    "encounter": {
  ...
  "molayne": {
    "encounter": {
      1: `J’ai donné mon titre de capitaine à Chrys, mais j’ai quand même confiance en mes capacités.
                $Ma force est comme celle d’une supernova !`
    },
    "victory": {
  ...
  "siebold": {
    ...
    "defeat": {
      1: `Ce combat m’aura apporté autant de satisfaction qu’un bon repas. 
                $J’espère par ces mots te montrer à quel point j’estime que tu te sois donné corps et âme.`,
    }
  },
  "roxie": {
    "encounter": {
  ...
  "grimsley": {
    ...
    "victory": {
      1: "Les combats Pokémon sont des jeux à somme nulle. Il y a toujours un vainqueur et un vaincu. La prochaine fois, je serai le vainqueur !"
    },
    "defeat": {
  ...
  "wikstrom": {
    ...
    "defeat": {
      1: `Mon cuer tremble, car j’ay si grant joie.
                $Car vraiement c’est un grans fais, mon rival j’ai subjugué !`,
    }
  },
  "acerola": {
    "encounter": {
  ...
  "grusha": {
    "encounter": {
      1: "Il suffit que je te congèle jusqu’aux os, et tout ira bien."
    },
    "victory": {
...
export const PGFdialogue: DialogueTranslationEntries = {
  ...
  "twins": {
    "encounter": {
      1: "Prépare-toi, parce que quand on fait équipe, c’est deux fois plus d’embrouilles !",
      2: "Deux cœurs, une stratégie – on va gagner grâce au pouvoir des jumelles !",
      3: "À deux contre une, nous sommes imbattables, alors prépare-toi !"
    },
    "victory": {
      1: "On a peut-être perdu ce combat, mais notre lien reste incassable !",
      2: "L’esprit des jumelles ne restera pas affaibli très longtemps.",
  ...
  "misty": {
    ...
    "victory": {
      1: "T’es pas mal, dis donc… Je dois bien l’admettre.",
      2: "Grrr… C’était juste un coup de chance, tu le sais ?!",
      3: "Wow, t’es trop forte ! J’arrive pas à croire que tu m’as battue !"
    },
    "defeat": {
      1: "Qu’en dis-tu ? C’est ça, la puissance des Pokémon Eau !",
      2: "J’espère que t’as vu les techniques de nage élégantes de mes Pokémon !",
  ...
  "giovanni": {
    ...
    "defeat": {
      1: "Ne pas pouvoir mesurer sa propre force montre que tu n’es encore qu’une gosse.",
      2: "Essaye de ne plus me gêner.",
      3: "J’espère que tu comprends à quel point c’était stupide de me défier."
    }
  },
  ...
  "liza": {
    "encounter": {
      1: "Hihihi…\nTu es surprise de me voir sans mon frère ?",
      2: "Je vois ce que tu désires…\nTu veux te battre, n’est-ce pas ?",
      3: "Comment vaincre quelqu’un…\nQui ne fait qu’un avec ses Pokémon ?"
    },
    "victory": {
  ...
  "cheren": {
    "encounter": {
      1: "Tu me rappelles une vieille amie. Cela m’enthousiasme pour ce combat !",
      2: `Veux-tu simplement montrer ta force ou comprendre l’essence du combat ?
      $Les combats de Pokémon n’ont aucun sens si l’on ne réfléchit pas à cela.`,
      3: "Je m’appelle Tcheren. Je suis Champion d’Arène et professeur à Pavonnay. Ravi de te rencontrer !"
    },
  ...
  "ramos": {
    "encounter": {
      1: "Tu es prête pour ta coupe de printemps, Maîtresse en herbe ? Hé hé !"
    },
    "victory": {
      1: "Ton équipe a foi en toi, et tu as toute confiance en elle… Ce combat m’a comblé !"
    },
  ...
  "geeta": {
    "encounter": {
      1: "Es-tu prête ? Alors, montre-moi toute l’étendue de tes talents !"
    },
    "victory": {
      1: "Célébrons ensemble ta victoire !"
    },
  ...
  "byron": {
    "encounter": {
      1: `Tu es une bien jeune Dresseuse, comme mon fils Pierrick !
         $Je crois, vois-tu, que les jeunes sont la clé d’un avenir radieux pour les Pokémon !
         $Moi, Charles, le protecteur des jeunes Dresseurs et du futur des Pokémon… aurai donc le plaisir de t’affronter !`
    },
    "victory": {
  ...
  "clemont": {
    "encounter": {
      1: "Alors, Dresseuse, tu es prête ? Il va falloir donner le meilleur de nous-mêmes !"
    },
    "victory": {
      1: "Rien de tel qu’observer les plus grands pour apprendre un maximum ! Merci de la leçon."
    },
