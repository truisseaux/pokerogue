...
export const PGMdialogue: DialogueTranslationEntries = {
  ...
  "misty": {
    "encounter": {
      ...
      3: "Mon rêve était de partir en voyage et d'affronter de puissants entraîneurs…         $Est-ce que tu seras à la hauteur ?"
    },
    "victory": {
  ...
  "juan": {
    "encounter": {
      ...
      4: "Prépare-toi à assister à une véritable démonstration de talent.         $Une œuvre sur le thème de l’eau composée par mes Pokémon et moi."
    },
    "victory": {
  ...
  "cheren": {
    ...
    "defeat": {
      ...
      2: "Très bien !",
      3: "Toi et moi, comme tous les Dresseurs, nous avons les Pokémon à nos côtés !         $C’est cela qui nous fait avancer. Ils nous accompagnent et nous donnent la force d'y croire."
    }
  },
  "chili": {
    "encounter": {
  ...
  "roark": {
    ...
    "defeat": {
      ...
      3: "J’ai vu quelque chose… Comme une vision."
    }
  },
  "morty": {
    "encounter": {
  ...
  "aaron": {
    "encounter": {
      1: "Si je me bats ici, c’est pour devenir parfait, comme les Pokémon Insecte !          $Alors que le duel commence !"
    },
    "victory": {
